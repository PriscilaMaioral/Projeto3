...
public class Cliente {
    ...
    public static ArrayList<Cliente> getList(){
        if(list==null){
            ...
            c2.setCelular("13 9 9999-2222");
            list.add(c2);
            
            Cliente c3 = new Cliente();
            c3.setCod("2");
            c3.setNome("Cicrano");
            c3.setEmail("circrano@domain.com");
            c3.setCelular("13 9 9999-3333");
            list.add(c3);
    ...
    public void alterar(String cod, String nome, String cpf, String rg, String email,String celular, String endereco){
        this.cod = cod;
        this.nome=nome;
        this.cpf=cpf;
        this.rg=rg;
